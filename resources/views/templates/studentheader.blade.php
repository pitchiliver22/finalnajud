...
<body>
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
        ...
        <h5>
            <a href="/studentdashboard" class="w3-bar-item w3-button">
            ...
            <a href="/studentprofile" class="w3-bar-item w3-button">
            ...
            <a href="/studentclassload" class="w3-bar-item w3-button">
            ...
            <a href="/enrollmentstep" class="w3-bar-item w3-button">
            ...
            <a href="studentgrades" class="w3-bar-item w3-button">
            ...
            <a href="studentassessment" class="w3-bar-item w3-button">
