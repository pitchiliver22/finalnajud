...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
        <div class="profile-section">
            ...
            <a href="/recordprofile">View Profile</a>
        </div>

        <h5>
            <a href="/record" class="w3-bar-item">
