...
<body>
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
        ...
        <a href="/teacher" class="w3-bar-item w3-button"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                height="16" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
                <path
                    d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293z" />
                <path d="m8 3.293 6 6V13.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5V9.293z" />
            </svg> Home</a>
        <a href="teacherprofile" class="w3-bar-item w3-button"><svg xmlns="http://www.w3.org/2000/svg" width="16"
        ...
        <a href="/teacherclassload" class="w3-bar-item w3-button"><svg xmlns="http://www.w3.org/2000/svg" width="16"
        ...
        <a href="/teacherattendance" class="w3-bar-item w3-button"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="/teachercorevalue" class="w3-bar-item w3-button"><svg xmlns="http://www.w3.org/2000/svg" width="16"
        ...
        {{-- <a href="/teachernotification" class="w3-bar-item w3-button"><svg xmlns="http://www.w3.org/2000/svg"
