            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3" style="margin-top:-40px;">
                        ...
                        <button type="button" class="editbtn mb-2" data-toggle="modal" data-target="#editProfileModal">Edit Profile</button>
                                </div>
                        <a href="/cashierupdateprofile">
