                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center">
                        <div class="text-center me-4">
                            @if ($picture)
                                <img src="{{ asset('storage/' . $picture->profile_picture) }}" alt="Profile Image" class="profile-image img-fluid mb-1" onerror="this.onerror=null; this.src='{{ asset('path/to/default/image.png') }}';">
                            @else
